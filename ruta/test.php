...
class RutaAutobus {
    ...
    public function mostrarInformacion() {
        ...
        $urlCompartir = urlencode("http://montyplus.com/ruta/test");
        echo '<div style="margin-top: 20px;">';
        echo '<a href="https://wa.me/?text=Te%20comparto%20esta%20ruta:%20' . $urlCompartir . '" target="_blank" style="text-decoration: none; background-color: #25D366; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold;">';
        echo '<i class="fab fa-whatsapp"></i> Compartir';
        echo '</a>';
        echo '</div>'; 
