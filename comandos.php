...
<body>
    ...
    <script>
        ...
        const mapboxAccessToken = 'pk.eyJ1IjoidmljZW50ZXJleWVzIiwiYSI6ImNtMnBtbjBxZDBza2YyanB1YWRzcDBjOGMifQ.R5Q04DQjFAmkTjmbLpuOAw'; // Reemplaza con tu Access Token de Mapbox
        ...
        async function getDirections(userLat, userLon, placeLat, placeLon) {
            const directionsUrl = `https://api.mapbox.com/directions/v5/mapbox/driving/${userLon},${userLat};${placeLon},${placeLat}?steps=true&geometries=geojson&access_token=${mapboxAccessToken}`;
            try {
